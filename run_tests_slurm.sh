...
# Usage:
#   TESTBENCH_PROFILE=donders_hcp ./run_tests_slurm.sh <test_suite> <test_name>
...
Environment options:
  TESTBENCH_PROFILE   Config profile to use (default: donders_hcp)
...
PROFILE="${TESTBENCH_PROFILE:-donders_hcp}"
